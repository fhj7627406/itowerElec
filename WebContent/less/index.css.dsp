...
.task.z-listbox .z-listbox-odd.z-listitem{
  background-color: #F9F9F9;
  background-image: none;
}
.task.z-listbox .task.z-listbox-odd.z-listitem:hover {
  background-color: #F9F9F9;
  background-image: none;
}

.task.z-listbox .z-listitem.z-listitem-selected > .z-listcell{
  background-color: #F4F9FC;
  background-image: none;
}
.task.z-listbox .z-listitem.z-listitem-selected:hover > .z-listcell{
  background-color: #F4F9FC;
  background-image: none;
}
.task.z-listbox {
...
.conversation.z-panel .body2 > .text2 {
  padding-left: 0px;
  padding-bottom: 3px;
}
...
.body2 > .text > [class*="z-icon-quote-"]:first-child {
  color: #DCE3ED;
  margin-right: 4px;
}
.body2 > .text:after {
...
.alertfont.z-window .z-caption {
	font-size:11px;
}
.alertfont.z-window .z-caption-content,
.alertfont.z-window .z-caption .z-label {
  font-size:11px;
}
.alertfont.z-window .z-caption{
	font-size:11px;
}
.alertfont.z-window .z-label{
	font-size:11px;
}

.tipspopup.z-popup:before{
  border-bottom:0;
  border-left: 0;
  border-right:0;
}
.tipspopup.z-popup:after{
  border-bottom: 0;
  border-left: 0;
  border-right: 0;
}
.tipspopup.z-popup .z-popup-content{
	padding:7px;
}
.tipspopup.z-popup .z-label{
	font-size:12px;
}
...
.myalert.z-window .z-caption {
  min-height: 0;
}
.myalert.z-window .z-caption-content,
.myalert.z-window .z-caption .z-label {
  float: none;
}
.myalert.z-window .z-label {
  font-size: 14px;
}
.myalert.z-window .z-window-content {
  display: none;
}
.myalert.z-window .z-window-icon.z-window-close {
  position: absolute;
  top: 20px;
  right: 15px;
  border: 0;
...
.myalert.z-window .z-window-icon.z-window-close:hover,
.myalert.z-window .z-window-icon.z-window-close:focus,
.myalert.z-window .z-window-icon.z-window-close:active {
  background-color: transparent;
}
.myalert.z-window .z-window-icon.z-window-close:hover {
  opacity: 0.5;
...
.myalert-success.z-window .z-window-header {
  color: #468847;
  padding: 0;
}
.z-window {
...
.rowPopup.z-popup:after, .rowPopup.z-menupopup:after {
  border:none;
  content:none;
}
.rowPopup.z-popup:before, .rowPopup.z-menupopup:before {
  border:none;
  content:none;
}
...
.mapPopup .z-popup-content {
  padding: 0;
}
.mapPopup .z-popup .z-popup-open:before {
  border-bottom: 7px solid rgba(0, 0, 0, 0.2);
  border-left: 7px solid transparent;
  border-right: 7px solid transparent;
  content: "";
...
.mapPopup .z-popup .z-popup-open:after {
  border-bottom: 6px solid #FFFFFF;
  border-left: 6px solid transparent;
  border-right: 6px solid transparent;
  content: "";
...
.gelecInfoGrid .z-grid-body{
	padding-bottom:17px;
}
.z-paging {
	background:none;
}
.z-listbox .z-listbox-emptybody td,.z-grid .z-grid-emptybody td{
	padding-top:17px;
}