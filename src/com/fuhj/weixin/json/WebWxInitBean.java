...
public class WebWxInitBean {
	...
	@Override public String toString() {
		return "WebWxInitBean{" + "baseResponse=" + baseResponse + ", count=" + count + ", contactList=" + contactList + ", syncKey=" + syncKey + ", user=" + user + ", ChatSet=" + ChatSet + ", Skey="
				+ Skey + ", ClientVersion=" + ClientVersion + ", SystemTime=" + SystemTime + '}';
	}
	...
	@SerializedName("User") private UserInfo user;

	private String ChatSet;

	@SerializedName("SKey") private String Skey;
